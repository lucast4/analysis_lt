%% 5/25/14 - Adult summary

clear all
ADAAind='25May2014_1607';
...
% PLOT transition matrices and difference matrices for all days
con_div = 'divergence';
all_days_all_analysis=lt_all_days_PLOT_AllTrans([1], '28Apr2014_2337', con_div);

con_div = 'convergence';
all_days_all_analysis=lt_all_days_PLOT_AllTrans([1], '28Apr2014_2337', con_div);


%% 4/28 - SUMMARY FIGURES FOR CP

% PLOT transition matrices and difference matrices for all days
con_div = 'divergence';
all_days_all_analysis=lt_all_days_PLOT_AllTrans([1 2 3], '26Mar2014_2341', con_div);
...
load /bluejay3/lucas/birds/bk74bk55/all_days_all_analysis/all_days_all_analysis_26Mar2014_2341_CPseq_AllTrans.mat
con_div = 'divergence';
...
close all
clear all
load all_days_all_analysis_26Mar2014_2341_CPseq_AllTrans
