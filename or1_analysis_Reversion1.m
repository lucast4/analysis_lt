...
Params_metadata.date_range={'27Mar2017', '27Mar2017'};
...
Params_glob.PreDur=0.3; % sec, how much data to take before targ
Params_glob.PostSylOnsetDur=0.15; % sec, data post to take
...
Params_glob.StimDelay=50; % in ms, delay from trigger to stim on
Params_glob.StimDur=125; % duration of Stim, in ms
Params_glob.StimType='pulse'; % either 'constant' or 'pulse'

%     	for pitch contour
Params_glob.PC_freqrange=[4050 5300]; % for both pitch contour and find note
...
Params_glob.TimeWindowList{1}=[242 250];
Params_glob.TimeWindowList{2}=[300 318];
...
TimeFieldsOfInterest = 1:2; % i.e. time windows in pitch contour
statfield='ffvals';
BaselineDays=1;
...
condition='';
notes='';
date_range={'25Feb2017', '27Mar2017'};
only_labeled_dirs=1;
