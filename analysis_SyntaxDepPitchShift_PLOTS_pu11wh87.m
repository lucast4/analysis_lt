...
% plot Ycombined
figure; 
h=errorbar(Ycombined.DayMeans,Ycombined.DaySE,'o-','Color',plot_colors{1},'MarkerFaceColor',plot_colors{1},'MarkerSize',7);
errorbar_tick(h,200);
...
baseline_mean=mean(Ycombined.DayMeans(baseline_days));
line(xlim,[baseline_mean,baseline_mean],'Color','k')
