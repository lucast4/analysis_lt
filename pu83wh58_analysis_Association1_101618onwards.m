...
config='/bluejay5/lucas/birds/pu83wh58/config101318_v2_v2.evconfig2';
config='/bluejay5/lucas/birds/pu83wh58/config101418.evconfig2';
...
% ####################### GENERAL PARAMS (shared across sykls)
    ...
    Params_metadata.date_range={'20Oct2018', '21Oct2018'};
...
condition='';
notes='';
date_range={'16Oct2018', '21Oct2018'};
only_labeled_dirs=1;
...
date_range_base={};
date_range_WN={'19Oct2018','21Oct2018'};
experiment = 'Association1';
