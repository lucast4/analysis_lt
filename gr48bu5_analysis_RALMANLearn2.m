...
ListOfDirs_UNDIR = {...
    '/bluejay0/bluejay2/lucas/birds/gr48bu5/NEURAL/011519_RALMANLearn2', ...
    };
...
FFparams.cell_of_freqwinds={'b', [2800 3850], 'h', [2950 3850], 'a', [1000 2250],...
     'd', [1300 2450]}; %
FFparams.cell_of_FFtimebins={'b', [0.042 0.0475], 'h', [0.027 0.031], 'a', [0.079 0.086], ...
    'd', [0.039 0.052]}; %
