...
% THIS IS ACTUALLY FOR SeqDepPitchShift2 experiment
...
% 2) experiment info
Params.SeqFilter.WNTimeON='26Nov2014-0000'; % Time WN turned on (1st WN day)
Params.SeqFilter.WNTimeOFF= '11Dec2014-2400'; % Time WN turned off (last WN day) ( use 0000 and 2400 if only plotting days)
...
% work in progress
DaysWanted=6:8; % either baseline (astring) or array
