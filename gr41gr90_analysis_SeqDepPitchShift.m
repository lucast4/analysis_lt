...
Params.DayRawDat.pc_time_window={[300 500],[37 140],[65 460],[250 335], [70 250], [50 150]};
...
%% Seq filter, remove outliers, and compile raw data, and enter experiment info into params [NEW - ONLY JBBACBB]
...
Params.SeqFilter.SylLists.TargetSyls={'jbbacbB'};
Params.SeqFilter.SylLists.SylsSame={'jBba','jbBa','jbbacB'};
...
%% Seq filter, remove outliers, and compile raw data, and enter experiment info into params [OLD, TOOK ALL MOTIFS]
% cd seq_dep_pitch_SeqDepPitchShift
% clear all; close all; 
% % 0) keep?
% Params.SeqFilter.AmplThr=10000;
