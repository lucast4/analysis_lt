...
% config='/bluejay3/lucas/birds/pu11wh87/config_091715_3.evconfig2'; % using new a
% config='/bluejay3/lucas/birds/pu11wh87/091815_SeqDepPitchLMAN5_durWN_day1/config.evconfig2';
config='/bluejay3/lucas/birds/pu11wh87/100215_SeqDepPitchLMAN6_durWN_day0/config.evconfig2';
config='/bluejay3/lucas/birds/pu11wh87/config_100715.evconfig2';
...
Params.DayRawDat.pc_harms=1; % harmonics to take weighted avg over. 1 or 2 is good.
Params.DayRawDat.syllables={'a','b','c', 'd'};
Params.DayRawDat.frequency_range={[1300 2200], [2800 3950],[2265 2990], [1415 2660]};
Params.DayRawDat.pc_dur=[0.135,0.125,0.125, 0.115];
Params.DayRawDat.pc_time_window={[365 485],[50 165],[135 300],[40 125]};
...
% cd seq_dep_pitch_SeqDepPitchLMAN6/
clear all; close all;
...
% 2) experiment info
Params.SeqFilter.WNTimeON='03Oct2015-0000'; % Time WN turned on (1st WN day)
