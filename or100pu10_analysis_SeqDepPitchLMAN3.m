% MATCHING TEMPLATE - b1
clear all; close all;
% config='/bluejay4/lucas/birds/or100pu10/config_111515.evconfig2';
% config='/bluejay4/lucas/birds/or100pu10/config_120815.evconfig2';
% config='/bluejay4/lucas/birds/or100pu10/120915_SeqDepPitchLMAN3_durWN_day1/config.evconfig2';
% config='/bluejay4/lucas/birds/or100pu10/config_121815.evconfig2';
config='/bluejay4/lucas/birds/or100pu10/121915_SeqDepPitchLMAN3_durWN_TwoTarg_day1/config.evconfig2';
...
Params.DayRawDat.pc_time_window={[140 280],[135 210],[250 305],[590 690]};
...
% 2) experiment info
Params.SeqFilter.WNTimeON='06Dec2015-0000'; % Time WN turned on (1st WN day)
Params.SeqFilter.WNTimeOFF= '08Dec2015-2400'; % Time WN turned off (last WN day) ( use 0000 and 2400 if only plotting days)
