%% targeting only kl(b), klb(h), io(b), iob(h).
% i.e all b, h,. except after jr

clear all; close all;
batchf='batch.labeled.all';
config='/bluejay2/lucas/birds/wh72pk12/config121718_lb.evconfig2'; % gets all b, by having birdtaf for each context, combined.
