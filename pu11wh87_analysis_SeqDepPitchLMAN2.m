...
% config='/bluejay3/lucas/birds/pu11wh87/config_062915_3.evconfig2'; % start 6/9 (no change from before)
% config='/bluejay3/lucas/birds/pu11wh87/063015_SeqDepPitchLMAN2_durWN_day1/config.evconfig2'; % wn start, 6/30
% config='/bluejay3/lucas/birds/pu11wh87/070215_SeqDepPitchLMAN2_durWN_day3/config_070215.evconfig2'; % 7/2 end day
config='/bluejay3/lucas/birds/pu11wh87/070315_SeqDepPitchLMAN2_durWN_day4/config_070315.evconfig2'; % 7/3
...
clear all; close all;
batchf='batch.labeled.all';
config='/bluejay3/lucas/birds/pu11wh87/config_071415_ab_and_abb.evconfig2'; % 7/3
...
% config='/bluejay3/lucas/birds/pu11wh87/060915_SeqDepPitchLMAN_TwoTargs_durWN/c.evconfig2'; % start 5/17 (changed template)
% 
% 
% syl='b';
% syl_pre='dcc';
...
% 2) experiment info
Params.SeqFilter.WNTimeON='30Jun2015-0000'; % Time WN turned on (1st WN day)
Params.SeqFilter.WNTimeOFF= '26Jul2015-1330'; % Time WN turned off (last WN day) ( use 0000 and 2400 if only plotting days)
...
Params.PlotLearning.MuscimolDaysToThrowout={'06Jul2015', '28Jul2015'};
